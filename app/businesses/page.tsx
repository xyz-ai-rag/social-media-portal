...
export default function Home() {
  ...
  if (!clientDetails || !clientDetails.businesses || clientDetails.businesses.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-6 text-center">
        <div className="max-w-md">
          <h2 className="text-xl font-semibold mb-4">No Businesses Found</h2>
          <p className="mb-6">
            Your account is authenticated, but we couldn't find any associated business data.
            This might happen if your account was recently created.
          </p>
          <p className="text-gray-600">
            Please contact support at <span className="font-medium">support@hyprdata.ai</span> for assistance.
          </p>
        </div>
      </div>
    );
    ...
    <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <div className="px-4 py-6 sm:px-0">
        <div className="rounded-lg bg-white shadow px-5 py-6 sm:px-6">
          <h2 className="text-lg font-medium text-gray-900 mb-4">Select a Business</h2>
          <p className="text-sm text-gray-500 mb-6">
            Please select a business to view its dashboard:
          </p>
          
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {clientDetails.businesses.map((business) => (
              <Link 
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-5">
                        ...
                        <p className="mt-1 max-w-2xl text-sm text-gray-500">
                          ...
                          {business.business_type && business.business_city && ' | '}
