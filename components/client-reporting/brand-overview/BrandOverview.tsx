...
import BusinessPostsTable from './BusinessPostsTable';
...
export default function BrandOverview({ clientId }: BrandOverviewProps) {
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
        ...
        <div className="md:col-span-3 w-full min-h-[340px] flex items-stretch">
          <LineGraph clientId={clientId} earliestDate={earliestDate} latestDate={latestDate} allBusinessIds={allBusinessIds} level={"monthly"} />
        </div>
        ...
        <div className="md:col-span-1">
          <BusinessPostsTable clientId={clientId} earliestDate={earliestDate} latestDate={latestDate} allBusinessIds={allBusinessIds} />
        </div>
        <div className="md:col-span-2">
          <NegativeFeedbackBubbleChart clientId={clientId} earliestDate={earliestDate} latestDate={latestDate} allBusinessIds={allBusinessIds} />
        </div>


        {/* line 4*/}
        <div className="md:col-span-3">
          <NegativeFeedbackLineGraph clientId={clientId} earliestDate={earliestDate} latestDate={latestDate} allBusinessIds={allBusinessIds} />
        </div>
      </div>
    </div>
  );
