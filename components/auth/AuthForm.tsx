      ...
      <Modal
        ...
        theme={{
          root: {
            ...
            show: {
              on: "flex bg-white bg-opacity-50 backdrop-blur-sm dark:bg-opacity-80"
            }
          },
          content: {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`bg-blue-50 border ${error ? 'border-red-500' : 'border-gray-300'} text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5`}
                  placeholder="••••••••••"
                  required
                />
              </div>
