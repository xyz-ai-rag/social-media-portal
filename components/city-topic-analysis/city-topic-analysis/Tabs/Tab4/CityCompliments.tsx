...
import ComplimentLineGraph from "./ComplimentLineGraph";
import MonthSelector from "../../MonthSelector";

interface CityComplimentsProps {
  businessId: string;
  clientId: string;
}

const CityCompliments: FC<CityComplimentsProps> = ({
  businessId,
  clientId,
}) => {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      setIsLoading(true);
      try {
        const url = `/api/city-topics/getCityTopicSMPI?businessId=${businessId}&type=Compliment&month=${selectedMonth}`;
        ...
        console.error('[CityCompliments] Error fetching data:', error);
        setBubbleData([]);
      } finally {
        setIsLoading(false);
      }
...
export default CityCompliments; 