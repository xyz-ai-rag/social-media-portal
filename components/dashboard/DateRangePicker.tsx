...
interface DateRangePickerProps {
  onDateRangeChange?: (startDate: string, endDate: string, label: string, aggregation: 'hourly' | 'daily' | 'weekly' | 'monthly') => void;
}
...
export default function DateRangePicker({ onDateRangeChange }: DateRangePickerProps) {
  ...
  }, [selectedPreset, customStartDate, customEndDate, onDateRangeChange, dateRangeContext]);
